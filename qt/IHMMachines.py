...
class window(QtWidgets.QMainWindow):
    ...
    def tableau_machine_3(self):
        produits_machine_3 = data_to_dict()
        
        self.ui.tableWidget_3.setRowCount(len(produits_machine_3))
        self.ui.tableWidget_3.setColumnCount(len(produits_machine_3[0]))
        #init tables
        self.ui.tableWidget_3.setHorizontalHeaderLabels(('id', 'id_machine', 'type_agv', 'distance (m)', 'temps (s)', 'etat_machine_1', 'etat_machine_2', 'etat_machine_3', 'etat_machine_4', 'nbs_pieces'))
        #taille des colonnes
        ...
        for i in produits_machine_3 :
            ...
            self.ui.tableWidget_3.setItem(nombre_produit,5,QTableWidgetItem(str(i['etat_machine_1'])))
            self.ui.tableWidget_3.setItem(nombre_produit,6,QTableWidgetItem(str(i['etat_machine_2'])))
            self.ui.tableWidget_3.setItem(nombre_produit,7,QTableWidgetItem(str(i['etat_machine_3'])))
            self.ui.tableWidget_3.setItem(nombre_produit,8,QTableWidgetItem(str(i['etat_machine_4'])))
            self.ui.tableWidget_3.setItem(nombre_produit,9,QTableWidgetItem(str(i['nbs_pieces'])))
...
#Tableau4
    ...
    def tableau_machine_4(self):
        produits_machine_4 = data_to_dict()
        
        self.ui.tableWidget_4.setRowCount(len(produits_machine_4))
        self.ui.tableWidget_4.setColumnCount(len(produits_machine_4[0]))
        #init tables
        self.ui.tableWidget_4.setHorizontalHeaderLabels(('id', 'id_machine', 'type_agv', 'distance (m)', 'temps (s)', 'etat_machine_1', 'etat_machine_2', 'etat_machine_3', 'etat_machine_4', 'nbs_pieces'))
        #taille des colonnes
        ...
        for i in produits_machine_4 :
            ...
            self.ui.tableWidget_4.setItem(nombre_produit,5,QTableWidgetItem(str(i['etat_machine_1'])))
            self.ui.tableWidget_4.setItem(nombre_produit,6,QTableWidgetItem(str(i['etat_machine_2'])))
            self.ui.tableWidget_4.setItem(nombre_produit,7,QTableWidgetItem(str(i['etat_machine_3'])))
            self.ui.tableWidget_4.setItem(nombre_produit,8,QTableWidgetItem(str(i['etat_machine_4'])))
            self.ui.tableWidget_4.setItem(nombre_produit,9,QTableWidgetItem(str(i['nbs_pieces'])))
